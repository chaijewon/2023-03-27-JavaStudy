...
public class 클래스구성요소 {
	...
	static int totalGesan(int kor,int eng,int math,int phy,int hi)
	{
	...
	static void scoreGesan(double avg)
	{
		char score='A';
		switch((int)(avg/10))
		{
	...
	public static void main(String[] args) {
		...
		int total=totalGesan(kor, eng, math, phy, hi);
		// int[]
